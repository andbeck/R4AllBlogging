...
They key is to make sure you organise things down to the level of the independent project.  Because inside these folders we suggest that you create the following two folders: __Data__ and __Scripts__.  The Data folder will hold the one or more datasets central to the project.  The Scripts folder will hold the analysis scripts you develop using R.
